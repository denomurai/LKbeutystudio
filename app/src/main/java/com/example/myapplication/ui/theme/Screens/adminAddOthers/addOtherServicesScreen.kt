package com.example.myapplication.ui.theme.Screens.adminAddOthers
...
@Composable
fun addOtherServicesScreeen(navController: NavController){
...
@Composable
fun addOthersPreview( ){
    addOtherServicesScreeen(rememberNavController())
