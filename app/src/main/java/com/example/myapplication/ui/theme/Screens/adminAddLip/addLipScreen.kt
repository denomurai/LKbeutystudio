package com.example.myapplication.ui.theme.Screens.adminAddLip
...
@Composable
fun addLipScreen (navController: NavController){
    ...
    Scaffold (
        ...
        )
        {
            ...
            Text("Add New Lip Service", fontSize = 24.sp, color = Color(color = 0xFF004D40))
...
@Composable
fun addLipPreview( ){
    addLipScreen(rememberNavController())
