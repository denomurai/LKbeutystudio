package com.example.myapplication.ui.theme.Screens.adminDashboard
...
import com.example.myapplication.navigation.ROUTE_ADD_Eyebrows
import com.example.myapplication.navigation.ROUTE_ADD_LASHES
import com.example.myapplication.navigation.ROUTE_ADD_Lip
import com.example.myapplication.navigation.ROUTE_ADD_Others
    ...
    Scaffold (
        ...
        bottomBar = {
            ...
            Column (modifier = Modifier.fillMaxSize().padding(innerPadding),
                ...
                Text("SERCICES", modifier = Modifier, fontSize = 30.sp, fontWeight = FontWeight.Bold)
                Spacer(modifier = Modifier.width(28.dp))

                Card (modifier = Modifier.padding(vertical = 15.dp, horizontal = 8.dp).fillMaxWidth(),
                    ...
                    Column  (modifier = Modifier.padding(16.dp).fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.Center){
                       /* Icon(Icons.Default.Person, contentDescription = "Add Employee", modifier = Modifier.size(40.dp), Color(0xFF004D40))
                        ...
                        Row (modifier = Modifier.fillMaxWidth(),Arrangement.SpaceEvenly){
                            ...
                            {Text("VIEW SERVICES") }
                            Button(onClick = {navController.navigate(ROUTE_ADD_Eyebrows)},colors = ButtonDefaults.buttonColors(containerColor = Color.DarkGray ))
                            {Text("ADD SERVICE") }
                        }
                ...
                Card (modifier = Modifier.padding(vertical = 15.dp, horizontal = 8.dp).fillMaxWidth(),
                    ...
                    Column  (modifier = Modifier.padding(16.dp).fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.Center){
                        ...
                        Text("LIP SERVICES",fontSize = 20.sp, color = Color.White)
                        Spacer(modifier = Modifier.size(13.dp))
                        Row (modifier = Modifier.fillMaxWidth(),Arrangement.SpaceEvenly){
                            Button(onClick = {},colors = ButtonDefaults.buttonColors(containerColor = Color.DarkGray ))
                            {Text("VIEW SERVICES") }
                            Button(onClick = {navController.navigate(ROUTE_ADD_Lip)},colors = ButtonDefaults.buttonColors(containerColor = Color.DarkGray ))
                            {Text("ADD SERVICE") }
                        }
                ...
                Card (modifier = Modifier.padding(vertical = 15.dp, horizontal = 8.dp).fillMaxWidth(),
                    ...
                    Column  (modifier = Modifier.padding(16.dp).fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.Center){
                        ...
                        Row (modifier = Modifier.fillMaxWidth(),Arrangement.SpaceEvenly){
                            Button(onClick = {},colors = ButtonDefaults.buttonColors(containerColor = Color.DarkGray ))
                            {Text("VIEW SERVICES") }
                            Button(onClick = {navController.navigate(ROUTE_ADD_LASHES)},colors = ButtonDefaults.buttonColors(containerColor = Color.DarkGray ))
                            {Text("ADD SERVICE") }
                        }
                ...
                Card (modifier = Modifier.padding(vertical = 15.dp, horizontal = 8.dp).fillMaxWidth(),
                    ...
                    Column  (modifier = Modifier.padding(16.dp).fillMaxWidth(), horizontalAlignment = Alignment.CenterHorizontally, verticalArrangement = Arrangement.Center){
                        ...
                        Row (modifier = Modifier.fillMaxWidth(),Arrangement.SpaceEvenly){
                            Button(onClick = {},colors = ButtonDefaults.buttonColors(containerColor = Color.DarkGray ))
                            {Text("VIEW SERVICES") }
                            Button(onClick = {navController.navigate(ROUTE_ADD_Others)},colors = ButtonDefaults.buttonColors(containerColor = Color.DarkGray ))
                            {Text("ADD SERVICE") }
                        }
